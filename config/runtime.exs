...
config :indexer, Indexer.Fetcher.Optimism.TransactionBatch.Supervisor,
       enabled: ConfigHelper.chain_type() == :optimism and !ConfigHelper.parse_bool_env_var("INDEXER_OPTIMISM_DISABLE_TRANSACTION_BATCH")
